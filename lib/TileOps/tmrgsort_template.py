...
def tmrgsort_1list_instr(dst: pto.Tile, src: pto.Tile,
    ...
    count = pto.ui64(num_structures)
    count = count | (pto.ui64(num_structures) << pto.ui64(16));
    count = count | (pto.ui64(num_structures) << pto.ui64(32));
    count = count | (pto.ui64(num_structures) << pto.ui64(48));

    config = pto.ui64(repeat_times)
    config = config | (pto.ui64(0b1111) << pto.ui64(8))
    config = config | (pto.ui64(0b0) << pto.ui64(12))
