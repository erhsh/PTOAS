...
extern "C" __global__ AICORE void TINSERT_vec2vec_nz_f16_16x16_into_32x32_idx00(
    __gm__ uint16_t *src, __gm__ uint16_t *dst, __gm__ uint16_t *out);
...
void LaunchVec2VecNZ_f16_16x16_into_32x32_idx00(uint16_t *src, uint16_t *dst, uint16_t *out, void *stream) {
    TINSERT_vec2vec_nz_f16_16x16_into_32x32_idx00<<<1, nullptr, stream>>>((__gm__ uint16_t *)src, (__gm__ uint16_t *)dst, (__gm__ uint16_t *)out);
}